        ...
        <PagesContiner pageNumber={pageNumber}>
          ...
          >
            <Page pageNumber={pageNumber} index={0}>
              <Home title="وبسایت رین | صفحه اصلی" />
            </Page>

            <Page pageNumber={pageNumber} index={1}>
              <About title="وبسایت رین | درباره من" />
            </Page>
            <Page pageNumber={pageNumber} index={2}>
              <Resume title="وبسایت رین | رزومه من" />
            </Page>
            <Page pageNumber={pageNumber} index={3}>
              <Samples title="وبسایت رین | نمونه کارها" />
            </Page>
            <Page pageNumber={pageNumber} index={4}>
              <Contact title="وبسایت رین | تماس با من" />
            </Page>
          </SwipeableViews>
        </PagesContiner>
      </MainLayout>
